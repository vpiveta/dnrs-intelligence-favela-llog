...
class CasoDNR(TimestampMixin, db.Model):
    ...
    login_utilizado = db.Column(db.String(255))
    login_proprio = db.Column(db.Boolean)
    proprietario_login = db.Column(db.String(255))
    categoria = db.Column(db.String(255))
    pedido = db.Column(db.String(160))
    data_abertura_dnr = db.Column(db.Date, index=True)
    data_dnr = db.Column(db.Date, index=True)
