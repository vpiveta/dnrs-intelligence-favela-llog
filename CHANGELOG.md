...
## 2.0.2 - Correção do Filtro Global

- Corrigido erro 500 causado pelo envio duplicado de `base_id` ao `render_template`.
- Revisadas as rotas Dashboard, Analytics, Inteligência Operacional e Sala de Guerra.
- Contexto do filtro global agora é montado em um único dicionário por tela, evitando parâmetros duplicados.
- Mantidos banco Supabase, usuários, importações e regras operacionais.
